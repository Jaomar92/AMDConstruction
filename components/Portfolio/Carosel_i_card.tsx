...
const Carosel_i_card = ({
  ...
  return (
    <article className={`relative rounded-2xl`}>
      <Image src={img} fill alt={title} className="-z-10 object-center " />
      <div className="bg-neutral-950/40 w-1/2 md:w-1/3 h-full flex flex-col justify-between">
        <div className="py-3 flex flex-col items-center justify-center">
          ...
          <h4 className="text-neutral-100 font-black text-3xl">{title}</h4>
          <p className="w-full text-neutral-100 font-medium text-md text-center">
            {des}
          </p>
        </div>
